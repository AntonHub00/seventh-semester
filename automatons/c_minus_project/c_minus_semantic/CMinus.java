...
System.out.println("\u005cn####Finished####\u005cn");
        ...
        System.out.format("%20s%20s%20s%20s\u005cn\u005cn", "Name", "Type", "Category", "Size");
...
{if ("" != null) return;}
  ...
  static final public String type_specifier() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case Int:{
...
{if ("" != null) return "real";}
  ...
  static final public void var_declaration() throws ParseException {String lexem, type; String[] category_and_size=new String[2];
    type = type_specifier();
    jj_consume_token(Id);
...
symbols_table.get(lexem).category=category_and_size[0];
  ...
  static final public String[] var_declaration_prime() throws ParseException {String category_and_size[]=new String[2];
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
category_and_size[0]= "array";
        {if ("" != null) return category_and_size;}
      break;
      }
    case Semicolon:{
      empty();
...
category_and_size[0]="variable";
  ...
  static final public void func_declaration() throws ParseException {String lexem, type, category; int size;
    type = type_specifier();
    jj_consume_token(Id);
lexem = token.image.toString();
...
symbols_table.get(lexem).category="function";
  ...
  static final public int params() throws ParseException {int counter;
    if (jj_2_2(2)) {
      counter = param_list();
...
{if ("" != null) return 0;}
  ...
  static final public int param_list() throws ParseException {int counter;
    param();
    counter = param_list_prime();
{if ("" != null) return counter+1;}
    throw new Error("Missing return statement in function");
  }

  static final public int param_list_prime() throws ParseException {int counter;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case Comma:{
...
{if ("" != null) return 0;}
  ...
  static final public void param() throws ParseException {String lexem, type, category;
    type = type_specifier();
    jj_consume_token(Id);
lexem = token.image.toString();
        if(symbols_table.containsKey(lexem)) System.out.println(getToken(0).beginLine +
...
symbols_table.get(lexem).category=category;
  ...
  static final public String param_prime() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LeftSquareBracket:{
      jj_consume_token(LeftSquareBracket);
      jj_consume_token(RightSquareBracket);
...
String param_type = symbols_table.get(param_id).type;
  ...
  static final public String expression(String param_id) throws ParseException {String var_id, lexem;
    if (jj_2_3(5)) {
      var_id = var(null);
if(param_id != null){
            String param_type = symbols_table.get(param_id).type;
...
{if ("" != null) return lexem;}
      ...
      case Number:
      case Decimal:{
        lexem = simple_expression(param_id);
{if ("" != null) return lexem;}
        break;
        }
      default:
  ...
  static final public String var(String param_id) throws ParseException {String lexem, array_index;
    jj_consume_token(Id);
lexem = token.image.toString();
    ...
    case LeftSquareBracket:{
      jj_consume_token(LeftSquareBracket);
      array_index = expression(param_id);
if(array_index==null){
            System.out.println(getToken(0).beginLine +
...
{if ("" != null) return lexem;}
  ...
  static final public String simple_expression(String param_id) throws ParseException {String lexem;
    lexem = additive_expression(param_id);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return lexem;}
  ...
  static final public String additive_expression(String param_id) throws ParseException {String lexem, other_additive_ex;
    lexem = term(param_id);
    other_additive_ex = additive_expression_prime(param_id);
{if ("" != null) return (other_additive_ex==null)?null:lexem;}
    throw new Error("Missing return statement in function");
  }

  static final public String additive_expression_prime(String param_id) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case Plus:
    case Minus:{
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return "empty";}
  ...
  static final public String term(String param_id) throws ParseException {String lexem, other_term;
    lexem = factor(param_id);
    other_term = term_prime(param_id);
{if ("" != null) return (other_term==null)?null:lexem;}
    throw new Error("Missing return statement in function");
  }

  static final public String term_prime(String param_id) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case Multiplier:
    case Slash:{
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return "empty";}
  ...
  static final public String factor(String param_id) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LeftParen:{
      jj_consume_token(LeftParen);
      expression(param_id);
  ...
  static private boolean jj_3R_30()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2a00,0x2a00,0x2a00,0x2a00,0x22000000,0x800,0x4000000,0x20000000,0x2a00,0x8a001500,0x8a001500,0xa000000,0x80,0xa000000,0x8000000,0x20000000,0x1ec0000,0x1ec0000,0xc000,0xc000,0x30000,0x30000,0x8000000,0x0,0x8000000,0x4000000,};
   }
